...
<main>
    ...
    <!-- Variable invisible -->
    <input type="hidden" name="gestor" id="gestor" value="crearTrobada">
    
    <!-- Selección de usuario -->
    <label for="idUsuari"><h5>Selecciona usuari:</h5></label>
    <select name="idUsuariCT" id="idUsuari" required>
    ...
    <label for="titolNovetat"><h5>Títol de la trobada:</h5></label>
    <input type="text" name="titolTrobadaCT" id="titolNovetat" maxlength="255" required>
    
    <!-- Cuerpo de la novedad -->
    <label for="cosNovetat"><h5>Cos de la trobada:</h5></label>
    <textarea name="cosTrobadaCT" id="cosNovetat" required></textarea>
    
    <!-- Fecha de la novedad -->
    <label for="dataNovetat"><h5>Data de la trobada:</h5></label>
    <input type="datetime-local" name="dataTrobadaCT" id="dataNovetat" required>
